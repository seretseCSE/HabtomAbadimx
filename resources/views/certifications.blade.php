...
@section('title', 'Certifications & Partners - ' . ($settings['company_name'] ?? 'Habtom Abadi Import Export'))

@section('content')
<!-- HERO -->
<section class="hero-bg relative overflow-hidden pt-40 pb-20 md:pt-44 md:pb-24">
    <div class="absolute inset-0 opacity-20">
        <img src="{{ asset('tractor.avif') }}" class="w-full h-full object-cover" alt=""/>
    </div>
    <div class="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <p class="text-green-100 text-lg max-w-2xl mx-auto">Our commitment to excellence and trusted global partnerships</p>
    </div>
</section>
